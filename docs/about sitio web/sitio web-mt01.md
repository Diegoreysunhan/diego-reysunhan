...
![Mi sitio web publicado en el navegador](../images/MT01/web.png){ width="600" style="display: block; margin: auto" }
...
![Mi sitio web publicado en el navegador](../images/MT01/cargando.png){ width="600" style="display: block; margin: auto" }
